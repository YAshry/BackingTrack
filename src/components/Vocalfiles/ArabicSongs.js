...
const ArabicSongs = () => {
    ...
    return(
        <div className='mb-6'>
            ...
            {/* Title / Order By */}
            <div className={`${arabic_songs_styles.main_page_title_container}` + " row m-0 mt-4 mb-4 ml-4 mr-4 pb-2 "} style={{width:'395px'}}>
                <div className={' row m-0 align-items-center pr-3'}>
                    <div className={`${arabic_songs_styles.main_page_title_icon}` + ' mr-2 '}>
                        <RiVoiceprintFill/>
                    </div>
                    <p className={`${arabic_songs_styles.main_page_title}` + ' m-0 '}>Vocal / Arabic Songs</p>
                </div>
