...
import arabic_music_styles from '../StyleSheets/generalCategories.module.css'; 
...
const ArabicMusic = () => {
    ...
    return(
        <div className='mb-6'>
            ...
            {/* Title / Order By */}
            <div className={`${arabic_music_styles.main_page_title_container}` + " row m-0 mt-4 mb-4 ml-4 mr-4 pb-2 "}>
                <div className={' row m-0 align-items-center pr-3'}>
                    <div className={`${arabic_music_styles.main_page_title_icon}` + ' mr-2 '}>
                        <GiGuitarHead/>
                    </div>
                    <p className={`${arabic_music_styles.main_page_title}` + ' m-0 '}>Instrumental / Arabic Music</p>
                </div>
                <div className={`${arabic_music_styles.orderby_dropdown}`}>
                    <div className={`${arabic_music_styles.orderby_title_container}` + ' row m-0 pr-2 pl-2 pt-1 pb-1 '}>
                        <p className={' m-0 mr-1'}>Order By</p>
                        <IoMdArrowDropdownCircle/>
                    </div>
                    <div className={`${arabic_music_styles.orderby_dropdown_content}`}>
